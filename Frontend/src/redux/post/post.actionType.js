...
export const CREATE_POST_REQUEST = 'GET_ALL_POST_REQUEST';
export const CREATE_POST_SUCCESS = 'GET_ALL_POST_SUCCESS';
export const CREATE_POST_FAILURE = 'GET_ALL_POST_FAILURE';
